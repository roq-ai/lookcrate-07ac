...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`LookCrate`}</title>

        <meta
          name="description"
          content="Welcome to LookCrate, your gateway to discover and connect with creators through our intuitive search tool. Unleash your creativity, one search at a time."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to LookCrate, your gateway to discover and connect with creators through our intuitive search tool. Unleash your creativity, one search at a time.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/reserve/LJIZlzHgQ7WPSh5KVTCB_Typewriter.jpg?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjcmVhdG9ycyUyQ3NlYXJjaCUyMHRvb2x8ZW58MHx8fHwxNjg3OTg0NTIxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
